...
```{r p1_2, eval=TRUE,echo=TRUE,warnings=FALSE}
library(foreign)
library(Epi)
...
```{r p1_3, eval=TRUE,echo=TRUE,warnings=FALSE}
library(haven)
library(data.table)
...
```{r p1_7, eval=TRUE,echo=TRUE}
table(bca$age.gr)
```

Data.table version

```{r p1_8, eval=TRUE,echo=TRUE}
...
```{r p1_9, eval=TRUE,echo=TRUE}
table(bca$HISTGRAD)
```

Data.table version

```{r p1_10, eval=TRUE,echo=TRUE}
